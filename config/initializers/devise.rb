...
Devise.setup do |config|
  ...
  # config.secret_key = 'd49c7aaf36df3aa9afffcaca1f8dea4639c2dde3514756a7f170aabe8682c28df505201df7c5c617c0c83a3795725c3a53d65401a7e811c12e82c521b7a24474'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = Rails.application.secrets.FROM
  ...
  # config.pepper = '3ef58d8ae015c099c510f2a86919d1fd68cc72da35e13010e99c540adda2d50364c1245f677aff7f56cf2aa5cd57c820ba0fe075239bc0eee2570d436b2f1994'
...
Rails.application.config.to_prepare do
  Devise::RegistrationsController.layout proc { |controller| user_signed_in? ? "settings" : "application" }
